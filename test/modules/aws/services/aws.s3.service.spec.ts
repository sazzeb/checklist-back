...
describe('AwsS3Service', () => {
    ...
    describe('checkBucketExistence', () => {
        it('should return the bucket existence details', async () => {
            ...
            const result = await service.checkBucket();
        ...
        it('should throw an error if S3Client send fails', async () => {
            ...
            await expect(service.checkBucket()).rejects.toThrow('Mock Error');
        });
    });
    ...
    describe('listBucket', () => {
        ...
        it('should throw an error if S3Client send fails', async () => {
            ...
            await expect(service.getBucket()).rejects.toThrow('Mock Error');
        });
    });
    ...
    describe('listItemInBucket', () => {
        it('should return a list of items in the bucket', async () => {
            ...
            const result = await service.checkItem('mock/path');
        ...
        it('should throw an error if S3Client send fails', async () => {
            ...
            await expect(service.checkItem('mock/path')).rejects.toThrow(
                'Mock Error'
            );
        });
    });
    ...
    describe('getItemInBucket', () => {
        it('should return the item from the bucket', async () => {
            ...
            const result = await service.getItem('mock/path/file.txt');
        ...
        it('should throw an error if S3Client send fails', async () => {
            ...
            await expect(
                service.getItems('mock/path/file.txt')
    ...
    describe('putItemInBucket', () => {
        it('should upload an item to the bucket', async () => {
            ...
            const result = await service.putItem(file, options);
            expect(result).toEqual({
                bucket: 'mockBucket',
                path: '/mock/path',
        ...
        it('should throw an error if S3Client send fails', async () => {
            ...
            await expect(service.putItemWithAcl(file)).rejects.toThrow(
                'Mock Error'
            );
        });
    });
    ...
    describe('deleteItemInBucket', () => {
        it('should delete an item in bucket', async () => {
            ...
            expect(await service.deleteItem('path/filename.txt')).toEqual(
                undefined
            );
        });
        ...
        it('should throw an error if S3Client send fails', async () => {
            ...
            await expect(
                service.deleteItem('path/filename.txt')
            ).rejects.toThrow('Mock Error');
        });
    });
    ...
    describe('deleteItemsInBucket', () => {
        it('should delete an items in bucket', async () => {
            ...
            expect(await service.deleteItems(['path/filename.txt'])).toEqual(
                undefined
            );
        });
        ...
        it('should throw an error if S3Client send fails', async () => {
            ...
            await expect(
                service.deleteItems(['path/filename.txt'])
            ).rejects.toThrow('Mock Error');
        });
    });
    ...
    describe('deleteFolder', () => {
        it('should delete a folder', async () => {
            ...
            expect(await service.deleteDir('/dir')).toEqual(undefined);
        });
        ...
        it('should throw an error if S3Client send fails', async () => {
            ...
            await expect(service.deleteDir('/dir')).rejects.toThrow(
                'Mock Error'
            );
        });
    });
    ...
    describe('setPresignUrl', () => {
        it('should return presign url', async () => {
            ...
            const result = await service.mapResponse(file);
            expect(result).toEqual({
                bucket: 'mockBucket',
                path: '/',
                pathWithFilename: '/file.txt',
        ...
        it('should return presign url with options', async () => {
            ...
            const result = service.mapPresign(file, options);
            expect(result).toEqual({
                bucket: 'mockBucket',
                path: '/path/new',
        ...
        it('should throw an error if S3Client send fails', async () => {
            ...
            await expect(service.mapResponse(file)).rejects.toThrow(
                new Error('presign error')
            );
        });
    });
